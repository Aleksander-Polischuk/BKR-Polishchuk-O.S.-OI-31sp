object fmJRN_Parts_Stock_Add: TfmJRN_Parts_Stock_Add
  Left = 0
  Top = 0
  ...
  object edID_PART: TcxDBLookupComboBox
    Left = 85
    Top = 77
    DataBinding.DataField = 'ID_PART'
    DataBinding.DataSource = dsDataField
  ...
  object edQUANTITY: TcxDBSpinEdit
    Left = 85
    Top = 108
  ...
  object spSaveForm: TFDStoredProc
    ...
    StoredProcName = 'JRN_PARTS_MOVEMENT_IU'
    Left = 276
    Top = 10
    ParamData = <
      item
