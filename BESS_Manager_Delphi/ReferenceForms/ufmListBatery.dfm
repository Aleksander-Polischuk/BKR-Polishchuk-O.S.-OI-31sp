object fmListBatery: TfmListBatery
  Left = 0
  Top = 0
  Caption = #1040#1082#1091#1084#1091#1083#1103#1090#1086#1088#1080
  ClientHeight = 489
  ClientWidth = 1105
  Color = clBtnFace
  ...
  object gList: TcxGrid
    ...
    object gListDBTableView: TcxGridDBTableView
      ...
      object gListDBTableViewNOMINAL_CAPACITY_KWH: TcxGridDBColumn
        Caption = #1055#1086#1074#1085#1072' '#1108#1084#1085#1110#1089#1090#1100' '#1082#1042#1090'/'#1075#1086#1076
        DataBinding.FieldName = 'NOMINAL_CAPACITY_KWH'
        DataBinding.IsNullValueType = True
      ...
      object gListDBTableViewNOMINAL_VOLTAGE: TcxGridDBColumn
        Caption = #1053#1072#1087#1088#1091#1075#1072' '#1079#1072#1088#1103#1076#1078#1077#1085#1086#1075#1086' '#1072#1082#1082#1091#1084'.'
        DataBinding.FieldName = 'NOMINAL_VOLTAGE'
        DataBinding.IsNullValueType = True
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.DisplayFormat = ',0.00;-,0.00'
        RowLayoutItem = gListDBTableViewLayoutItem6.Owner
      end
      object gListDBTableViewSOC_MIN_LIMIT: TcxGridDBColumn
        Caption = #1052#1110#1085'. '#1088#1110#1074#1077#1085#1100' '#1088#1086#1079#1088#1103#1076#1091
        DataBinding.FieldName = 'SOC_MIN_LIMIT'
        DataBinding.IsNullValueType = True
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.DisplayFormat = ',0.00;-,0.00'
        RowLayoutItem = gListDBTableViewLayoutItem10.Owner
      end
      object gListDBTableViewSOC_MAX_LIMIT: TcxGridDBColumn
        Caption = #1052#1072#1082#1089'. '#1088#1110#1074#1077#1085#1100' '#1079#1072#1088#1103#1076#1091
        DataBinding.FieldName = 'SOC_MAX_LIMIT'
        DataBinding.IsNullValueType = True
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.DisplayFormat = ',0.00;-,0.00'
        RowLayoutItem = gListDBTableViewLayoutItem11.Owner
      end
      object gListDBTableViewEFFICIENCY_RATE: TcxGridDBColumn
        Caption = #1045#1092#1077#1082#1090#1080#1074#1085#1110#1089#1090#1100' %'
        DataBinding.FieldName = 'EFFICIENCY_RATE'
        DataBinding.IsNullValueType = True
        PropertiesClassName = 'TcxCurrencyEditProperties'
