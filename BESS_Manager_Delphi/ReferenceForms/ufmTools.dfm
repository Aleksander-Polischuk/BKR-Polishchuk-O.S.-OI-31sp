object fmTools: TfmTools
  Left = 0
  Top = 0
  Caption = #1056#1110#1079#1072#1083#1100#1085#1110' '#1110#1085#1089#1090#1088#1091#1084#1077#1085#1090#1080
  ClientHeight = 489
  ClientWidth = 1105
  Color = clBtnFace
  ...
  object gList: TcxGrid
    ...
    object gListDBTableView: TcxGridDBTableView
      ...
      object gListDBTableViewDIAMETER: TcxGridDBColumn
        Caption = 'D '#1088#1110#1079#1072#1083#1100#1085#1086#1111' '#1082#1088#1086#1084#1082#1080
      ...
      object gListDBTableViewMAX_RPM: TcxGridDBColumn
        Caption = #1052#1072#1082#1089#1080#1084#1072#1083#1100#1085#1072' '#1096#1074#1080#1076#1082#1110#1089#1090#1100' '#1086#1073#1077#1088#1090#1072#1085#1085#1103
        DataBinding.FieldName = 'MAX_RPM'
        DataBinding.IsNullValueType = True
        PropertiesClassName = 'TcxCurrencyEditProperties'
        Properties.Alignment.Horz = taLeftJustify
