object fmListMaterial: TfmListMaterial
  Left = 0
  Top = 0
  ...
  object gList: TcxGrid
    ...
    object gListDBTableView: TcxGridDBTableView
      ...
      object gListDBTableViewIS_ROLL: TcxGridDBColumn
        DataBinding.FieldName = 'IS_ROLL'
        DataBinding.IsNullValueType = True
        PropertiesClassName = 'TcxImageComboBoxProperties'
      ...
      object gListDBTableViewLENGTH: TcxGridDBColumn
        Caption = #1044#1086#1074#1078#1080#1085#1072' '#1083#1080#1089#1090#1072' ('#1084#1084')'
      ...
      object gListDBTableViewWIDTH: TcxGridDBColumn
        Caption = #1064#1080#1088#1080#1085#1072' '#1083#1080#1089#1090#1072' ('#1084#1084')'
