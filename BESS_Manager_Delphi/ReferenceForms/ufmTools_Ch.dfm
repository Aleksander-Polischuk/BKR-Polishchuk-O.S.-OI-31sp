object fmTools_Ch: TfmTools_Ch
  Left = 0
  Top = 0
  Caption = #1056#1110#1079#1072#1083#1100#1085#1080#1081' '#1110#1085#1089#1090#1088#1091#1084#1077#1085#1090
  ClientHeight = 182
  ClientWidth = 882
  Color = clWhite
  ...
  object Label3: TLabel
    ...
    Width = 48
    Height = 17
    Caption = #1044#1110#1072#1084#1077#1090#1088
  end
  object Label4: TLabel
    ...
    Width = 81
    Height = 17
    Caption = #1052#1072#1082#1089'. '#1086#1073#1077#1088#1090#1080
  end
  ...
  object edDiameter: TcxDBCurrencyEdit
    Left = 123
    Top = 77
    DataBinding.DataField = 'DIAMETER'
    DataBinding.DataSource = dsDataField
    Properties.Alignment.Horz = taLeftJustify
  ...
  object edMaxRPM: TcxDBCurrencyEdit
    Left = 123
    Top = 108
    DataBinding.DataField = 'MAX_RPM'
    DataBinding.DataSource = dsDataField
    Properties.Alignment.Horz = taLeftJustify
  ...
  object spDataField: TFDQuery
    ...
    SQL.Strings = (
      'select * from REF_TOOLS where id=:id')
    Left = 579
    ParamData = <
      item
        Name = 'ID'
