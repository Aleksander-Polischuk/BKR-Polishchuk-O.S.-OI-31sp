object fmPriceElectricity: TfmPriceElectricity
  Left = 0
  Top = 0
  Caption = #1042#1072#1088#1090#1110#1089#1090#1100' '#1077#1083#1077#1082#1090#1088#1086#1077#1085#1077#1088#1075#1110#1111
  ClientHeight = 489
  ClientWidth = 1105
  Color = clBtnFace
  ...
  object gList: TcxGrid
    ...
    object gListDBTableView: TcxGridDBTableView
      ...
      object gListDBTableViewDATE_START: TcxGridDBColumn
      ...
      object gListDBTableViewDATE_END: TcxGridDBColumn
      ...
      object gListDBTableViewTIME_START: TcxGridDBColumn
        Caption = #1063#1072#1089' '#1087#1086#1095#1072#1090#1086#1082
      ...
      object gListDBTableViewTIME_END: TcxGridDBColumn
        Caption = #1095#1072#1089' '#1082#1110#1085#1077#1094#1100
        DataBinding.FieldName = 'TIME_END'
        DataBinding.IsNullValueType = True
        RowLayoutItem = gListDBTableViewLayoutItem12.Owner
      end
      object gListDBTableViewPRICE_PER_KWH: TcxGridDBColumn
        Caption = #1062#1110#1085#1072' '#1079#1072' '#1082#1042#1090
        DataBinding.FieldName = 'PRICE_PER_KWH'
        DataBinding.IsNullValueType = True
